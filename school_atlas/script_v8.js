// General parameters (December 2024 - these could change in the future because of new versions of the School Atlas of Statistik Austria)

var school_year_description = "data_2023_2024";
...
// The next API url must be completed adding the identifier of each individual school that we are interested in (see below)
...
const known_students_in_the_4th_class_in_this_school_year = 18092; // Data from the school year 2023/2024 (see below)
// NOTE: in other data, also from Statistik Austria, you can find a slightly different value.
...
// But data tell actually a completely different story:
// - also Vorschulklassen (0. Schulstufe) are part of the data that are provided from the various APIs of the various schools.
// - Vienna is (currently) a growing city, with increasing number of children.
...
// Download that file. For the school year 2023/2024 the downloadable file was called "12_-_Klassenschuelerzahlen23.ods"
// and it was available at https://www.statistik.at/fileadmin/pages/441/12_-_Klassenschuelerzahlen23.ods
...
// (approximate to the nearest integer if need be). We get hence the following data:

// Vorschule:  2.494  (2.918 in 2022/2023)
// 1st class: 21.656 (20.030 in 2022/2023)
// 2nd class: 19.625 (18.912 in 2022/2023)
// 3rd class: 19.316 (18.699 in 2022/2023)
// 4th class: 18.382 (17.866 in 2022/2023) - NOTE: in the table mentioned below we have a value of 18.092
...
// Download that file. For the school year 2023/2024 the downloadable file was called 13_-_UEbertritte_Vorbildung_23.ods"
// and it was available at https://www.statistik.at/fileadmin/pages/443/13_-_UEbertritte_Vorbildung_23.ods
// (we write this for reference, in case we need it for future use)
...
// These are the data of 2023/2024:
...
// (the files listed below are the ones used in October 2024, this could change in the future).
...
const school_categories = {
  ...
  hs: {
    ...
    types: ["NMSH", "HS"],
    // NOTE: HS does not exist anymore (in the data of 2023/24), this code is left here just for statistical reasons for past years
  ...
  bmhs: {
    ...
    // NOTE: LHS seems not to exist anymore (in the data of 2023/24), we leave also this code here for completeness of
